...
export const allProjects = [
  ...
  },
  {
    ...
    img: 'https://omeiirr.github.io/Portfolio/images/projects/school-app.png',
    description:
      'A demo web app to manage the typical administration tasks in a school, like attendance, academic calendar, events, etc.',
    techUsed: ['react'],
    demoLink: 'https://omeiirr.github.io/School-App/#/',
    githubLink: 'https://github.com/omeiirr/School-App',
  },
  {
    title: 'Tinder Clone',
    img: 'https://omeiirr.github.io/Portfolio/images/projects/tinder-clone.png',
    description:
      'A clone of the popular app, Tinder, made with React & MaterialUI, and Firebase as the backend.',
    techUsed: ['react', 'firebase'],
    demoLink: 'https://tinder-clone-44b4e.web.app/',
    githubLink: 'https://github.com/omeiirr/tinder-clone',
  },
];
